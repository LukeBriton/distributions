...
- **OCR-Nougat**: trying to reconstruct the book with better specialized OCR into markdown (then maybe to pdf).
    ...
    - Multi-GPU, Large Batch: e.g. `accelerate launch --num_processes 2 nougat_multi_gpu.py "distributions_fixed.pdf" --out distributions.mmd --batch 40 --scale 5.0`, could utilize all VRAM (maximum 24GiB of each) of 2 RTX 3090, taking less than 4 min for the same PDF.    
